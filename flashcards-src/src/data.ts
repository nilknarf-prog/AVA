...
export const bancosDeQuestoes: Deck[] = [
  {
    ...
    cards: [
      ...
      { id: 'dp14', assunto: 'Teoria Finalista (Welzel)', frente: 'Na teoria finalista (adotada no CP), onde ficam o dolo e a culpa e quais os 3 elementos da culpabilidade?', verso: 'Dolo e culpa ficam na CONDUTA (fato típico). A culpabilidade é normativa pura, composta pelo IPE: Imputabilidade, Potencial consciência da ilicitude e Exigibilidade de conduta diversa.' },
      { id: 'dp15', assunto: 'Dolo Normativo vs Dolo Natural', frente: 'Qual a diferença entre o Dolo Normativo (Causalismo) e o Dolo Natural (Finalismo)?', verso: 'Dolo Normativo (Causalismo/Neokantismo): Ficava na culpabilidade e continha a consciência da ilicitude (dolus malus). Dolo Natural (Finalismo): Fica no fato típico e é composto apenas por CONSCIÊNCIA e VONTADE (a potencial consciência da ilicitude tornou-se elemento autônomo da culpabilidade).' },
    ],
  },
  {
    id: 'dpp',
